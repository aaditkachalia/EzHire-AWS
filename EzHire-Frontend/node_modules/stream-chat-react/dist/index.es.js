  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("img", {
        ...
        alt: fallback
      }), React__default.createElement(ModalGateway, null, this.state.modalIsOpen ? React__default.createElement(Modal$1, {
  ...
  function ReactionsList(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderReactions", function (reactions) {
      ...
      return Object.keys(reactionsByType).map(function (type) {
        ...
        }, React__default.createElement(NimbleEmoji, _extends({
...
function (_React$PureComponent) {
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement("p", null, images.length - 3, " more")), React__default.createElement(ModalGateway, null, this.state.modalIsOpen ? React__default.createElement(Modal$1, {
        onClose: this.toggleModal,
...
function (_PureComponent) {
  ...
  function MessageInputLarge() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderUploads", function () {
      return React__default.createElement(React__default.Fragment, null, _this.props.imageOrder.length > 0 && React__default.createElement(ImagePreviewer, {
      ...
      }), _this.props.fileOrder.length > 0 && React__default.createElement(FilePreviewer, {
  ...
  _createClass(MessageInputLarge, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
      ...
      }, React__default.createElement(ImageDropzone, {
        ...
        fillRule: "evenodd"
      }))), React__default.createElement(FileUploadButton, {
        multiple: this.props.multipleUploads,
        disabled: this.props.numberOfUploads >= this.props.maxNumberOfFiles ? true : false,
...
function (_PureComponent) {
  ...
  _createClass(MessageSimple, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement(MessageInput, _extends({
...
function (_React$PureComponent) {
  ...
  _createClass(LoadMoreButton, [{
    ...
    value: function render() {
      ...
      }, this.props.refreshing ? React__default.createElement(LoadingIndicator$1, null) : this.props.children));
    }
  }]);
...
function (_PureComponent) {
  ...
  _createClass(ChannelListTeam, [{
    ...
    value: function render() {
      ...
      if (this.props.error) {
        return React__default.createElement(LoadingErrorIndicator, {
          type: "Connection Error"
        });
      } else if (this.props.loading) {
        return React__default.createElement(LoadingIndicator, null);
      } else {
        return React__default.createElement("div", {
...
function (_PureComponent) {
  ...
  function MessageInputFlat() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderUploads", function () {
      ...
      }, React__default.createElement(FilePreviewer, {
        uploads: _this.props.fileOrder.map(function (id) {
          return _this.props.fileUploads[id];
        }),
        handleRemove: _this.props.removeFile,
...
function (_React$PureComponent2) {
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      }, "Start of a new thread"), React__default.createElement(MessageList, _extends({
...
export { Attachment, AttachmentActions, Audio, Avatar, Card, Channel, ChannelContext, ChannelHeader, ChannelList, ChannelListMessenger, ChannelListTeam, ChannelPreview, ChannelPreviewCompact, ChannelPreviewCountOnly, ChannelPreviewLastMessage, ChannelPreviewMessenger, ChannelSearch, Chat, ChatAutoComplete, ChatContext, ChatDown, CommandItem, DateSeparator, EditMessageForm, EmoticonItem, EmptyStateIndicator, EventComponent, Gallery, Image, InfiniteScroll, InfiniteScrollPaginator, Item, KEY_CODES, List, LoadMoreButton, LoadMorePaginator, LoadingChannels, LoadingErrorIndicator, LoadingIndicator, MESSAGE_ACTIONS, Message, MessageActions, MessageActionsBox, MessageCommerce, MessageInput, MessageInputFlat, MessageInputLarge, MessageInputSmall, MessageList, MessageLivestream, MessageNotification, MessageRepliesCountButton, MessageSimple, MessageTeam, Modal, ReactionSelector, ReactionsList, ReverseInfiniteScroll, SafeAnchor, SendButton, SimpleReactionsList, Thread, Tooltip, TypingIndicator, UserItem, Window, byDate, commonEmoji, defaultMinimalEmojis, defaultScrollToItem, emojiData, emojiSetDef, formatArray, generateRandomId, isOnlyEmojis, isPromise, Listeners as listener, renderText, smartRender, withChannelContext, withChatContext };
